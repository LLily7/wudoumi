...
非常规题型示例：数字化技术能够创新文化遗产及其背后中华优秀传统文化的展示方式，还可以帮助修缮和保护文物本身。敦煌莫高窟建设“数字敦煌”和“云游敦煌”，集探索、游览等功能于一体；湖北省博物馆等越来越多博物馆“搬”到网上，成为“不打烊”的博物馆；在秦腔艺术节上，由三维建模的数字化代言人秦筱雅展示秦腔······数字化技术既可以弥补游客因客观原因不能亲临现场的遗憾，也能强化文化遗产展示的互动性和参与感。

文段接下来最可能介绍的是：

 

A. 数字技术强化文遗展示互动性的具体途径

B. 数字化技术为何会被应用于传统文化产业
...
解析：根据提问方式可知，本题为接语选择题。文段开篇介绍数字化技术能够创新文化遗产及其背后中华优秀传统文化的展示方式，还可以帮助修缮和保护文物本身，接着以敦煌莫高窟、湖北省博物馆、秦腔艺术节为例，介绍数字化技术是如何展示文化遗产的，尾句论述了通过数字化技术展示文化遗产的意义。文段介绍了数字化技术于文化遗产、文物两方面的作用，并已论述过数字化技术展示文化遗产的例子及其意义，故接下来可能围绕数字化技术如何修缮和保护文物展开论述。

A项，“强化文遗展示互动性的具体途径”文段已经论述过，后文不会继续论述；

B项，“传统文化产业”与文段核心话题不一致，衔接不当；

D项，“数字化展示”文段已经论述过，后文不会继续论述。

【文段出处】《一线一中轴，文化遗产保护插上数字化翅膀》
